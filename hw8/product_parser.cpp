...
{
    Product* b = new Book("book", prodName_, price_, qty_, isbn_, author_);
...
{
    Product* c = new Clothing("clothing", prodName_, price_, qty_, size_, brand_);
...
{
    Product* m = new Movie("movie", prodName_, price_, qty_, genre_, rating_);
